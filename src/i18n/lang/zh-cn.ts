...
export default {
	...
	input: {
		...
		lsl:'规格下限LSL',
		upperLimitValueX:'上限值UCL(X)',
		centralLimitValueX:'中心限CL(X)',
		lowerLimitValueX:'下限值LCL(X)',
		upperLimitValueS:'上限值UCL(S)',
		centralLimitValueS:'中心限CL(S)',
		lowerLimitValueS:'下限值LCL(S)',
		standardDeviationStdDev:'标准差Std.Dev',
		standardDeviationSigma:'标准差Sigma',
		pp:'Pp',
		ppk:'Ppk',
		cp:'Cp',
		cpu:'CPU',
